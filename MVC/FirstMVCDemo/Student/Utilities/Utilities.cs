...
namespace FirstMVC.Ulities
{
    public static class Utilities
    {
        public static async Task<ExcelPackage> ExportExcel(string tenSheet, List<string> HeaderExcel, List<List<string>> BodyExcel, string CellNameAddress, int RowHeaderIndex, int RecordIndex)
        {
